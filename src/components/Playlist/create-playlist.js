...
import Navbar from "../Home/homepage-menu";
            ...
            <form onSubmit={handleSubmit} className="mt-3">
                <div className="mb-3">
                    ...
                    <input
                        ...
                        onChange={handleForm}
                        className={`form-control ${playlist.title.length >= 10
                            ? "is-valid"
                            : playlist.title !== ""
                                ? "is-invalid"
                                : ""
                ...
                <button
                    type="submit"
                    className={`btn btn-primary ${playlist.title.length >= 10 && playlist.describe !== ""
                        ? ""
                        : "disabled"
                        }`}
                >
